...
class data_generator:
    ...
    def augment(image):
        ...
        # augment_img = iaa.SomeOf((0, 3), [
        # iaa.Fliplr(1.0),
        # iaa.Flipud(1.0),
        # iaa.ContrastNormalization((0.75, 1.5)),
        # iaa.Crop(percent=(0, 0.1)),
        # iaa.AdditiveGaussianNoise(loc=0, scale=(0.0, 0.05*255), per_channel=1)
        # ])
...
submit['Predicted'] = predicted
np.save('draw_predict_InceptionV3_2.npy', score_predict)
submit.to_csv('submit_InceptionV3_2.csv', index=False)
...
submit['Predicted'] = predicted
np.save('draw_predict_InceptionV3_3.npy', score_predict)
submit.to_csv('submit_InceptionV3_3.csv', index=False)